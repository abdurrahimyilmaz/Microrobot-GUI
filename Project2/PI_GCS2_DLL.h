...
// Copyright (C) 1995-2012 PHYSIK INSTRUMENTE GmbH
// All rights reserved.
//
...
BOOL PI_FUNC_DECL PI_SPA_int64(int ID, const char* szAxes, const unsigned int* iParameterArray, const int* piValueArray);
BOOL PI_FUNC_DECL PI_qSPA_int64(int ID, const char* szAxes, unsigned int* iParameterArray, int* piValueArray);
BOOL PI_FUNC_DECL PI_SEP_int64(int ID, const char* szPassword, const char* szAxes, const unsigned int* iParameterArray, const int* piValueArray);
BOOL PI_FUNC_DECL PI_qSEP_int64(int ID, const char* szAxes, unsigned int* iParameterArray, int* piValueArray);
